...
/** AiCameraPlugin */
public class AiCameraPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "ai_camera")
    ...
    AiCameraSelector(context = flutterPluginBinding.applicationContext,binaryMessenger = flutterPluginBinding.binaryMessenger);
  }
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "ai_camera")
      ...
      AiCameraSelector(context = registrar.context(),binaryMessenger = registrar.messenger());
    }
  }
